...
namespace AwfulRedux.Tools.Background
{
    public class BackgroundTaskUtils
    {
        public const string BackgroundTaskEntryPoint = "AwfulRedux.BackgroundNotify.BackgroundNotifyStatus";
        public const string BackgroundTaskName = "BackgroundNotifyStatus";
        public const string ToastBackgroundTaskEntryPoint = "AwfulRedux.BackgroundNotify.ToastNotificationBackgroundTask";
