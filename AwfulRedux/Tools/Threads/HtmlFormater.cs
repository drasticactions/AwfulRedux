...
namespace AwfulRedux.Tools.Threads
{
    public static class HtmlFormater
    {
        ...
        public static async Task<string> FormatSaclopediaEntry(string body)
        {
        ...
        public static async Task<string> FormatThreadHtml(Thread forumThreadEntity, List<Post> postEntities)
        {
